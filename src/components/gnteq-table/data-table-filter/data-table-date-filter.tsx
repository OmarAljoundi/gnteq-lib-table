...
import Calendar from '../../gnteq-ui/Calender/calendar'
...
export default function DataTableDateFilter<TData, TValue>({ column, title }: DataTableDateFilter<TData, TValue>) {
  return (
    <div className={cn('grid xl:gap-2 w-1/2 lg:w-1/4 xl:w-1/6')}>
      <Popover>
        <PopoverTrigger asChild>
          <Button id="date"  className={cn('w-[calc(100%-10px)]  justify-start text-left font-normal')}>
