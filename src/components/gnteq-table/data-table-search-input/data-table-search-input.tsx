...
import Input from '../../gnteq-ui/Input/input'
...
export default function DataTableSearchInput<TData, TValue>({ column, title, placeholder }: DataTableSearchInputProp<TData, TValue>) {
